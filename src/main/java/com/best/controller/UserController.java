...
public class UserController {
	...
	// public String memberManager(HttpServletRequest req, HttpServletResponse
	// resp, Model model) throws IOException {
	//
	// if (!CommonUtils.checkSessionTimeOut(req))
	// return "redirect:/login.do";
	//
	...
	// model.addAttribute("nextPage", ((page + 1) > totalPage ? totalPage :
	// (page + 1)) + "");
