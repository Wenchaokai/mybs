jQuery(function($){
	...
	if($("#mod-detail-table-container")[0]){
        ...
        $('button',"#mod-detail").click(function(){
        	getDataTrendDetailDataByAjax($(this).data('url'));
//            getDataDetailDataByAjax($(this).data('url'));
        ...
        getDataTrendDetailDataByAjax($('#trend-chart').data('url'));
    ...
    function getDataTrendDetailDataByAjax(url){
    	$('#trend-chart').html('').addClass("loading");
            $.ajax({
                url:url,
                type:'GET',
                dataType:'json',
