...
public class StatisticService extends BaseService {
	...
	private static final String SKU_IDO_STATISTIC_REPORT_PREFIX = "SKU_IDO_STATISTIC_REPORT_PREFIX_";
	...
	public String getWareHouseSkuIdoCount(String skuCode, Map<String, WareHouse> wareHouse, String customerCode,
			String startTime, String endTime, String excelFileName) {

		StringBuffer keyAppend = new StringBuffer(SKU_IDO_STATISTIC_REPORT_PREFIX);
		keyAppend.append(skuCode).append("_").append(customerCode).append("_").append(startTime).append("_").append(endTime);
		for (String wareHouseCode : wareHouse.keySet()) {
			keyAppend.append("_").append(wareHouseCode);
		}
		String key = keyAppend.toString();
		...
		try {
			...
			// 生成excel文件
			CommonUtils.createIdoSkuExcelFile(startTime, endTime, wareHouseMap, wareHouse, baseDir, excelFileName);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public String getDistributedSkuIdoCount(String skuCode, String customerCode, String startTime, String endTime,
		...
		try {
			...
			// 生成excel文件
			CommonUtils.createIdoDisSkuExcelFile(startTime, endTime, dateMap, baseDir, excelFileName);
	...
	public String getPercentSkuIdoCount(String skuCode, String customerCode, String startTime, String endTime,
			String excelFileName, Model model) {
		StringBuffer keyAppend = new StringBuffer(SKU_PER_STATISTIC_REPORT_PREFIX);
		keyAppend.append(skuCode).append("_").append(customerCode).append("_").append(startTime).append("_").append(endTime);
		...
		try {
			...
			// 生成excel文件
			CommonUtils.createIdoSkuPerExcelFile(startTime, endTime, percentMap, skuPercentMap, baseDir, excelFileName);
