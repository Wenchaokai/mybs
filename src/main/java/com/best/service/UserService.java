...
public class UserService extends BaseService {
	...
	public List<User> getSearchUsers(String searchName, String searchCount, String customerSelected, String warehouseSelected,
			Integer page) throws TimeoutException, InterruptedException, MemcachedException {
		List<User> res = null;
		// 从缓存读取数据
		// String key = "";
		...
		res = userDao.findUserByPageSize(searchName, searchCount, customerSelected, warehouseSelected, start);
	...
	public int getTotalSize(String searchName, String searchCount, String customerSelected, String warehouseSelected)
		...
		res = userDao.findUserTotalSize(searchName, searchCount, customerSelected, warehouseSelected);
		// memcachedClient.add(key, 0, res);
		return res;
	}
	...
	public void resetPasswordMember(String userId) {
		userDao.resetPasswordMember(userId);
	}
